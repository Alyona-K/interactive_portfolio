...
//------------------
{
  /* <button
          ...
          >
            <svg className="header__burger-icon" width={24} height={24}>
              <use xlinkHref={`${sprite}#burger-menu-icon`} />
            </svg>
          </button> */
}
...
// Отслеживание скролла для стекла

{
  /* <button
              className={`header__btn ${lang === "EN" ? "header__btn--active" : ""}`}
              onClick={() => setLang("EN")}
            >
              EN
            </button>
            <button
              className={`header__btn ${lang === "ES" ? "header__btn--active" : ""}`}
              onClick={() => setLang("ES")}
            >
              ES
            </button> */
